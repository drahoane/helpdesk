...
public class SalesChain extends TicketAssignmentChain {

    public SalesChain(TicketService ticketService, EmployeeUserService employeeUserService) {
    ...
    public void assign(Ticket ticket) {
        ...
        Set<EmployeeUser> availableEmployees = employeeUserService.getAllUnassignedEmployees()
                .stream()
                .filter(x -> x.getDepartment().equals(Department.SALES))
